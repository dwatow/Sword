========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Sword
========================================================================


AppWizard has created this Sword application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Sword application.
...
res\Sword.ico
    ...
    icon is included by the main resource file Sword.rc.
...
SwordDlg.h, SwordDlg.cpp - the dialog
    These files contain your CSwordDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Sword.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CSwordDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Sword.pch and a precompiled types file named StdAfx.obj.
